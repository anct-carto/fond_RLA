	...
	evaluate: function() {
		...
		if (value.length >= this.minChars && this._list && this._list.length > 0) {
			...
			if (this.ul.children.length === 0) {
                ...
                // DESACTIVÉ this.status.textContent = "No results found";
                ...
                // DESACTIVÉ this.status.textContent = this.ul.children.length + " results found";
			}
		}
		else {
			this.close({ reason: "nomatches" });
...
//Fonction modifiée pour la carte interactive RLA
